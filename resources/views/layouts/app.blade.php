    ...
    <div id="sidebar-menu" >
      <ul >
        ...
        {{-- @if (Auth::user()->role=='admin') --}}
          ...
          <li class="has_sub ">
            <a href="" class="waves-effect "><i class="mdi mdi-buffer "></i> <span>Web Home Data</span> </a>
            <ul class="list-unstyled">
          ...
          <li class="has_sub ">
            <a href="" class="waves-effect "><i class="mdi mdi-buffer "></i> <span>Footer Data</span> </a>
            <ul class="list-unstyled">
              ...
              <li><a href="{{url('social_link')}}" > <i class="mdi mdi-clock ">Follow Us Data</i>   
                {{-- <li><a href="" > <i class="mdi mdi-clock ">Contact Us</i>  
                <li><a href="" > <i class="mdi mdi-clock ">About Us</i>    --}}
              {{-- <li><a href="" > <i class="mdi mdi-clock ">Cancel Policy</i>    
              <li><a href="" > <i class="mdi mdi-clock ">Terms Condition</i>    
              <li><a href="" > <i class="mdi mdi-clock ">Privacy Policy</i>     --}}
            </a> 
            </ul>
          </li>
        ...
        <li class="has_sub ">
          <a href="" class="waves-effect "><i class="mdi mdi-buffer "></i> <span> Blog Data</span> </a>
          <ul class="list-unstyled">
            <li><a href="" > <i class="mdi mdi-clock "> Create User</i>
            <li><a href="" > <i class="mdi mdi-clock "> All Users</i>    
          </a> 
          </ul>
        </li>
