                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-200">
                            <div class="card-body">
                                ...
                                <form class="" action="{{url('footer_social')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label style="color: black"><strong>Facebook Link</strong> </label>
                                           <input type="text" class="form-control" name="facebook"  placeholder="full title" required>
                                            </div>
                                        </div>       
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label style="color: black"><strong> Twitter Link</strong> </label>
                                           <input type="text" class="form-control" name="twitter"  placeholder="full title" required>
                                            </div>
                                        </div>       
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label style="color: black"><strong>Instagram Link</strong> </label>
                                           <input type="text" class="form-control" name="instagram"  placeholder="full title" required>
                                            </div>
                                        </div>  
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($social_footer as $key=> $social_footer)
                                                <tr>
                                                    <td>{{$key+1}}</td>
                                                    <td>{{$social_footer->facebook}}</td>
                                                    <td>{{$social_footer->twitter}}</td>
                                                    <td>{{$social_footer->instagram}}</td>
