                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-200">
                            <div class="card-body">
                                ...
                                <form class="" action="{{url('footer_save')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label style="color: black"><strong>Footer title</strong> </label>
                                           <input type="text" class="form-control" name="title"  placeholder="full title" required>
                                            </div>
                                        </div>  
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <textarea name="description"  class="form-control"  cols="110" rows="05"></textarea>
                                                </div>
                                            </div>
                                        </div> 
