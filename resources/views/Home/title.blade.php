                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-200">
                            <div class="card-body">
                                ...
                                <form class="" action="{{url('save_title')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <textarea name="description"  class="form-control"  cols="110" rows="6"></textarea>
                                                </div>
                                            </div>
                                        </div> 
                                    </div>
                                ...
                                <div class="card m-b-20">
                                    <div class="card-body">
                                        ...
                                        <table id="" class="table table-bordered  nowrap"
                                            ...
                                            <tbody>
                                                @foreach ($home_title as $key=> $home_title)
                                                <tr>
                                                    <td>{{$key+1}}</td>
                                                    <td>{{$home_title->title}}</td>
                                                    <td>{{$home_title->description}}</td>
                                                
                                                    {{-- <td>
                                                        <form action="{{url('title_delete',$title->id)}}"
                                                            method="POST">
                                                            @method('DELETE')
                                                            @csrf
