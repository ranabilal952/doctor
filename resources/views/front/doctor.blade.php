...
<div class="doctor-offers-box country" style="    width: 50%; margin-right: 25%; height: 127px;">
    <p class="ng-binding"><i class="fa fa-times fa-color-yellow"></i> تحدث اونلاين مع المعالج النفسي وانت جالس في بيتك: جلسات فورية أو في الوقت الذي يناسبك</p>
    <div class="top-doctor-services" style="display: inline-flex;">
        <div class="video-service" style="margin: 5px; margin-right: 28px; margin-top: 20px;background: #138DE7;"><i class="las la-video mt-1" style="margin-right: 4px; font-size: 18px;"></i></div>
        <div class="chat-service" style="margin: 5px;margin-top: 20px; background: #138DE7;"><i class="las la-comment-alt mt-1" style="margin-right: 4px;"></i></div>
        <div class="whatsapp-service" style="margin: 5px;margin-top: 20px;"><i class="lab la-whatsapp" style="margin-right: 5px;"></i></i>
        </div>
    </div>
...
<!-- wizerd -->
<div class="mt-5">
<p class="title-primary-boxed title-boxed ng-binding text-center" style="font-family: 'hnn';font-weight: bold;font-size: 1.5rem;">المتاحين الأن</p>
<p class="text-center" style="    padding: 15px;margin-right: 50px;font-size: 15px;color:#3362CC">يمكنك الحجز مع المعالج المتاح والتحدث فوراً</p>
<div class="row">
...
<h3 class="text-center" style="padding: 45px;font-size: 40px;font-weight: 700;">اسئلة حول دكتورك | طبيب نفسي اونلاين</h3>
