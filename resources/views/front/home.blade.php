...
<div class="text-center mt-3">
    ...
    <div style="padding: 2% 20% 0% 20%;">
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Error impedit iusto dolores repudiandae numquam minus explicabo, placeat non possimus, temporibus fugiat tenetur dolorem velit ratione assumenda quidem quia commodi asperiores!</p>
    </div>
</div>
<!-- doctor -->
            ...
            <strong> كيف تتم جلسة الفيديو مع الطبيب النفسي؟</strong>
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        تتم الجلسة صوت وصورة، او صوت فقط ان كنت تحبذ هذا. وتتم من خلال غرفة الكترونية في ملفك الشخصي في الموقع عبر دكتورك، او من خلال غرفة خارجية. او من خلال أي تطبيق اتصال تفضله انت.
                    </div>
                </div>
            </div>
            <div class="accordion-item">
...
<section class="wow mt-5">
    <div class="">
        ...
        ">
                <span class="timer counter alt-font appear" style="font-size: 50px; color: #3362cc; font-weight: 700">300</span
        >
        ...
        " data-wow-duration="600ms" style="
          ...
          animation-name: fadeInUp;
        ">
                <span class="timer counter alt-font appear" style="font-size: 50px; color: #3362cc; font-weight: 700">9576+</span
        >
        ...
        " data-wow-duration="900ms" style="
          ...
          animation-name: fadeInUp;
        ">
                <span class="timer counter alt-font appear" style="font-size: 50px; color: #3362cc; font-weight: 700">8567+</span
        >
        ...
        " data-wow-duration="1200ms" style="
          ...
          animation-name: fadeInUp;
        ">
                <span class="timer counter alt-font appear" style="font-size: 50px; color: #3362cc; font-weight: 700">6956</span
        >
...
<section class="container">
    <div class="row">
        <div class="col-lg-6">
            <iframe width="100%" height="480" src="https://www.youtube.com/embed/RmEd-7Oczmw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <div class="col-lg-6">
...
<section class="blog-home mt-5 container">
    ...
    <div class="">
        <div class="row">
            <div class="col-lg-4">
                <div class="card">
                    <img class="card-img-top" src="{{url('web/assets/images/blog1.webp')}}" alt="Card image cap" />
                    <div class="card-body">
                        <p>Jun 14, 2021</p>
            ...
            <div class="col-lg-4">
                <div class="card">
                    <img class="card-img-top" src="{{url('web/assets/images/blog2.webp')}}" alt="Card image cap" />
                    <div class="card-body">
                        <p>Jun 14, 2021</p>
                        <p class="card-text">فوبيا الأماكن المزدحمة: الأسباب والعلاج</p>
                    </div>
