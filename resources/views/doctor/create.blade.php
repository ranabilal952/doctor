                        ...
                        <div class="card-body">
                            ...
                            <form class="" action="{{ url('doctor_detail_save') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label style="color: black"><strong>Orignal Price / السعر الأصلي</strong>
                                            </label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label style="color: black"><strong>30 Minutes Rate / معدل 30
                                                    دقيقة</strong></label>
                                            <input type="text" class="form-control" name="thirty_minute_price" id=""
                                                placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label style="color: black"><strong>60 Minutes Rate / معدل 60
                                                    دقيقة</strong></label>
                                            <input type="text" class="form-control" name="sixty_minute_price" id=""
                                                placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label style="color: black"><strong>Number Of Rating total / عدد إجمالي
                                                    التصنيف</strong> </label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label style="color: black"><strong>Availability of Doctor / توافر طبيب
                                                </strong> </label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label style="color: black"><strong>Whatsapp Contact / واتس اب
                                                    الاتصال</strong></label>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label style="color: black"><strong>User Name (for rating) / اسم المستخدم
                                                    (للتقييم)</strong></label>
                                            <input type="text" class="form-control" name="user_name_rating" id=""
                                                placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="video_link1" id=""
                                                placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="video_link2" id=""
                                                placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="video_link3" id=""
                                                placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="video_link4" id=""
                                                placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="video_link5" id=""
                                                placeholder="">
                                        </div>
                                    </div>
                                </div>
