                ...
                <div class="col-lg-12">
                    <div class="card m-b-200">
                        <div class="card-body">
                            ...
                            <form class="" action="{{ url('reward-doctor') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label><strong style="color: black">Reason:
                                                </strong></label>
                                            <div>
                                                <textarea name="reason" class="form-control" id="" cols="30"
                                                    rows="10"></textarea>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card m-b-20">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">All Rewards </h4>
                                    <p class="text-muted m-b-30 font-14"></p>
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" cellspacing="0"
                                        ...
                                        <tbody>
                                            @foreach ($rewards as $key => $reward)
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
                                                    <td>{{ $reward->amount }}.00 USD</td>
                                                    <td>{{ ucfirst($reward->user->name) }}</td>
                                                    <td>{{ $reward->reason }}</td>
                                                </tr>
                                            @endforeach
